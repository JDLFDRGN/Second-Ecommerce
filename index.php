...
<body>
    <?php
        ...
        if(isset($_POST['check-out'])){
            ...
            $query = "INSERT INTO cart(productID, customerID)
                      VALUES('$selected_product','$customer_id');";
            $connect->query($query);
        }
    ?>
    <div class="container">
        ...
        <section class="first-section">   
            <div class="home-products">
                <?php
                    $select = $connect->query("SELECT * FROM product ORDER BY productID DESC;");
            ...
            <div class="home-buy-buttons">
                <?php
                    if(isset($_COOKIE['customerID'])){
                        ...
                        echo "<input type='submit' value='Check out' name='check-out'>";
                        echo "<input type='button' value='Cancel' onclick='hideBuyForm()'>";
                    }else{
                        echo "<input type='button' value='Login' id='substitute-login'>";
                        echo "<input type='button' value='Cancel' onclick='hideBuyForm()'>";
                    }
                ?>
            </div>
